...
// a good chunk of the stuff that you write in your code is
// strictly speaking, not directly controlled by JS
...
// it’s not provided by the JS engine
// nor is it particularly controlled by the JS specification
// it takes the form of something that looks an awful lot like a normal JS object
// but it’s not really exactly that
...
// in some (newer-generation) browsers
// this layer may also be in JS
// but traditionally the DOM and its behavior is implemented in something more like C/C++
...
// the call you make sends the message to the browser internals
// and it handles drawing and displaying the message box
