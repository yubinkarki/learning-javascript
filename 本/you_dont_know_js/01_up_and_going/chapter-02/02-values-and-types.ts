...
// i.e. type of "abc" returns "string", not string
...
// typeof null is an interesting case
// because it errantly returns "object" when you’d expect it to return "null"
...
// also, note a = undefined - we’re explicitly setting 'a' to the undefined value
// but that is behaviorally no different from a variable that has no value set yet
// like with the var a; line at the top of the snippet
// a variable can get to this “undefined” value state in several different ways
// including functions that return no values and usage of the void operator
