...
// most programs need to track a values as it changes over the course of the program
// undergoing different operations as called for by your program's intended tasks
...
// static typing, otherwise knows as type enforcement
// is typically cited as a benefit for program correctness by preventing unintended value conversions
...
// this is more typically called constants
// when you declare a variable with a value and intend for the value to not change throughout the program
var TAX_RATE = 0.08;
var newAmount = 99.99;
...
// the TAX_RATE variable is only constant by convention
...
// if you tried to assign  any different value to VAT_RATE after that first declaration
// your program would reject the change
// this kind of "protection" against mistakes is similar to the static-typing type enforcement

// VAT_RATE = 10; // TypeError: Assignment to constant variable.
