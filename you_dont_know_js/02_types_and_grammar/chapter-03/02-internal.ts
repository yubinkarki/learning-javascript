...
// but can generally can be revealed indirectly by borrowing the default Object.prototype.toString(..) method called against the value
...
// but for the other simple primitives like string, number and boolean, another behavior actually kicks in
// which is usually called "boxing"
...
// in this snippet, each of the simple primitives are automatically boxed by their respective object wrappers
...
// there are even gotchas with using object wrappers directly that you should be aware of if you do choose to ever use them
...
// but objects themselves are truthy - so using the object behaves oppositely to using the underlying false value itself
